...
#   mv /usr/local/bin/gh /usr/bin/gh-real
...
# If token manager found, inject token (GitHub App first)
...
# Fall back to session PAT when App auth is unavailable
